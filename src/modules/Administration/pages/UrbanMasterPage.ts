...
export class UrbanMasterPage extends CbsPage {
  protected readonly screenId = 'URBANMASTER';
  ...
  async create(data: UrbanMasterData): Promise<string> { await this.fillForm(data); return this.save(); }
